...
|------|-------------|-------|-------------|
| 1992 | Linear programming | Koller, D., & Megiddo, N. (1992). [The complexity of two-person zero-sum games in extensive form](https://doi.org/10.1016/0022-0000(92)90007-H) | Early attempts at solving extensive games made use of linear programming. |
...
| 2013 | Distribution-aware card abstraction | Johanson, M., Burch, N., Valenzano, R., & Bowling, M. (2013). [Evaluating state-space abstractions in extensive-form games](https://dl.acm.org/doi/10.5555/2484920.2484953) | Expanded abstraction to consider not only hand equities, but future hand strength distributions. |
...
| 2015 | Unsafe subgame solving | Ganzfried, S., & Sandholm, T. (2015). [Endgame Solving in Large Imperfect-Information Games](https://dl.acm.org/doi/10.5555/2772879.2772882) | Search in imperfect-information games, lacking theoretical guarantees. |
